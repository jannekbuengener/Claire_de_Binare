...
from core.config.rate_limits import get_rest_rate_limit_config
...
_rate_limit_config = get_rest_rate_limit_config()
...
@rate_limit(
    max_requests=_rate_limit_config.burst_max_requests,
    time_window=_rate_limit_config.burst_time_window
)
def health():
    """Health check endpoint"""
    return (
...
@rate_limit(
    ...
    time_window=_rate_limit_config.time_window
)
def status():
