...
REDUCE_ONLY_ADAPTER_BOUND = "REDUCE_ONLY_ADAPTER_BOUND"
REDUCE_ONLY_DISPATCH_CLAIMED = "REDUCE_ONLY_DISPATCH_CLAIMED"
REDUCE_ONLY_CLAIM_MISMATCH = "REDUCE_ONLY_CLAIM_MISMATCH"

# Reasons that may still acquire exclusive Redis-dispatch ownership (risk path).
REDUCE_ONLY_DISPATCH_CLAIMABLE_REASONS = frozenset(
    {
        REDUCE_ONLY_READY,
...
# Claim rows that may still be bound once for adapter submission.
# Includes DISPATCH_CLAIMED so execution can bind after risk won dispatch.
REDUCE_ONLY_BINDABLE_REASONS = frozenset(
    {
        REDUCE_ONLY_READY,
        REDUCE_ONLY_QUANTITY_CLAMPED,
