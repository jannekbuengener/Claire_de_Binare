...
class FeatureRollbackManager:
    ...
    def rollback_feature(self, feature_name: str, rollback_type: str = "feature_flag") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            self.logger.info(f"Rollback completed successfully for feature: {feature_name}")
        ...
        try:
            ...
            if get_feature_flag_manager:
                ...
                if feature_name in flag_manager.get_all_flags():
                    ...
                    validation_results["feature_disabled"] = flag.state == FeatureFlagState.DISABLED
    ...
    def emergency_rollback_all(self) -> Dict[str, Any]:
        ...
        if get_feature_flag_manager:
            ...
            for feature_name, flag in all_flags.items():
                if flag.state != FeatureFlagState.DISABLED:
                    rollback_result = self.rollback_feature(feature_name, "feature_flag")
        ...
        self.logger.warning(f"Emergency rollback completed. Success: {results['successful_rollbacks']}, Failed: {results['failed_rollbacks']}")
...
def main():
    ...
    parser.add_argument("--type", choices=["feature_flag", "config", "full"], 
                       default="feature_flag", help="Rollback type")
    parser.add_argument("--dry-run", action="store_true", 
                       help="Perform dry run without making changes")
    parser.add_argument("--emergency", action="store_true",
                       help="Emergency rollback of all features")
