...
> **Retired (PR #2994, 2026-06-05):** The `cdb_agent_sdk/` package was removed from the Claire de Binare repository. Agent guidance now lives in `.codex/cdb_skills/` and `.opencode/skills/`. This document is retained as historical reference only.
