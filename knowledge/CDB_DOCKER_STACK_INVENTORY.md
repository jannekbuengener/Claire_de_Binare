...
- [Docs Root](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docs)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `cdb_redis` | image | n/a | n/a | n/a | n/a | `docker-compose.base.yml` | [Base compose](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docker-compose.base.yml) | `redis:7.4.6-alpine` | `cdb_redis` | none | `6379` | `redis-cli -a /run/secrets/redis_password ping` |
| `cdb_postgres` | image | n/a | n/a | n/a | n/a | `docker-compose.base.yml` | [Base compose](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docker-compose.base.yml) | `postgres:15.8-alpine` | `cdb_postgres` | none | `5432` | `pg_isready -U claire_user -d claire_de_binare` |
...
| `cdb_regime` | build | `.` | [Repo root](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare) | `services/regime/Dockerfile` | [Dockerfile: services/regime/Dockerfile](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/services/regime/Dockerfile) | `docker-compose.base.yml` | [Base compose](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docker-compose.base.yml) | `claire_de_binare-cdb_regime` | `cdb_regime` | `cdb_redis, cdb_postgres` | `8005->8000` | `curl -fsS http://localhost:8005/health` |
| `cdb_allocation` | build | `.` | [Repo root](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare) | `services/allocation/Dockerfile` | [Dockerfile: services/allocation/Dockerfile](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/services/allocation/Dockerfile) | `docker-compose.base.yml` | [Base compose](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docker-compose.base.yml) | `claire_de_binare-cdb_allocation` | `cdb_allocation` | `cdb_redis, cdb_postgres` | `8006->8000` | `curl -fsS http://localhost:8006/health` |
| `cdb_market` | build | `.` | [Repo root](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare) | `services/market/Dockerfile` | [Dockerfile: services/market/Dockerfile](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/services/market/Dockerfile) | `docker-compose.base.yml` | [Base compose](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docker-compose.base.yml) | `claire_de_binare-cdb_market` | `cdb_market` | `cdb_redis, cdb_postgres` | `8007->8000` | `curl -fsS http://localhost:8007/health` |
| `cdb_paper_runner` | build | `tools/paper_trading` | [Tools directory](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/tools/paper_trading) | **MISSING - needs Dockerfile creation** | [Dockerfile: tools/paper_trading/Dockerfile](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/tools/paper_trading/Dockerfile) | `docker-compose.base.yml` | [Base compose](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/docker-compose.base.yml) | `claire_de_binare-cdb_paper_runner` | `cdb_paper_runner` | `cdb_core, cdb_execution, cdb_postgres, cdb_redis, cdb_risk` | `8004->8000` | `curl -fsS http://localhost:8004/health` |
...
## Networks
- The stack defines the logical `cdb_network` bridge; the explicit Docker network name is `cdb_network`. All active services attach to this bridge.
...
- **Infrastructure Images Updated:**
  - Redis: `redis:7-alpine` → `redis:7.4.6-alpine` (fixes 4 CRITICAL + 40 HIGH CVEs)
  - PostgreSQL: `postgres:15-alpine` → `postgres:15.8-alpine` (fixes 5 HIGH CVEs)
- **Python Images Hardened:**
  - All services upgraded pip to 25.3 (fixes MEDIUM CVE-2025-8869)
  - Base images changed to `python:3.11-slim-bookworm` (stable vs testing)
  - Execution service optimized with multi-stage build (722MB → ~250MB)
- **CI/CD Security:**
  - Docker Scout vulnerability scanning integrated into pipeline
  - Automated CRITICAL/HIGH vulnerability detection and reporting

## Freeze notes
- The stack is in AUDIT + FREEZE mode: do not edit compose files, Dockerfiles, secret layouts, or networks; only run verification, documentation, or scripting work documented here.
- All build contexts remain inside `Claire_de_Binare`, and start/stop helpers above are official entry points for this phase.
- Security posture improved from MODERATE to LOW risk through comprehensive vulnerability remediation.
...
- [Secrets directory](file:///C:/Users/janne/Documents/GitHub/Workspaces/.cdb_local/.secrets)
- [Inventory document](file:///C:/Users/janne/Documents/GitHub/Workspaces/Claire_de_Binare/knowledge/CDB_DOCKER_STACK_INVENTORY.md)
