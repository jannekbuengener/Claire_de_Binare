...
date: '2025-12-17'
status: 'Refactored — historical concept (obsolete external advisor; #2689)'
tags:
  - Architektur
  - Sicherheit
  - Sandboxing
...
> **Historical concept.** Obsolete external advisor reference removed. Active gate: explicit Jannek Human-GO + repo evidence.
