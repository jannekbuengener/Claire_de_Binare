...
| G0-9 | Docker/BLUE/RED/compose change requires explicit Jannek Human-GO (obsolete external advisor reference removed) | Explicit Human-GO (forbidden in #2803) |
...
| **Jannek Human-GO** | Infra/runtime | Human | **Only** for Docker/BLUE/RED/compose; obsolete external advisor reference removed — **forbidden in #2803** |
...
| FU-4 | Runtime activation / compose (Jannek Human-GO; obsolete external advisor reference removed) | `[PHASE-2] context runtime activation` (infra explicit) |
