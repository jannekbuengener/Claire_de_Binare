...
| **Allocation** | cdb_allocation | 8006 | services/allocation/ | [README](../../services/allocation/README.md) | **AKTIV** | Regime→Allocation Mapping; `ALLOCATION_RULES_JSON` in `compose.blue.yml` deckt `paper`, `primary_breakout_v1`, und `donchian_breakout_v1` ab (Donchian nutzt konservative half-cap Regime-Map; PR #3915); campaign overlay `manifests/runtime_np_parallel_allocation_compose_override.yml` spiegelt dieselbe Semantik fuer HYP-NP-PARALLEL-2S-01 |
