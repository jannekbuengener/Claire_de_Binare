...
start. It now resolves only to local repository sources.

## Canonical Locations (current)

- Claire de Binare repository / engineering status: `CURRENT_STATUS.md`
...
- Canon and archive policy: `docs/meta/REPOSITORY_CANON.md`
...
No default path in the roadmap should require an external documentation
repository. Use individual historical artifacts or Git history only for
historical lookup.
