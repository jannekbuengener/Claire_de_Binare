...
EXPECTED_STRESS = 5
EXPECTED_MONTHLY_VALIDATION = 25
EXPECTED_MONTHLY_OOS = 17

# Frozen lock from live Binance window bank (#4032 / WP4 evidence).
LOCKED_STAGE_B_SELECTION_SHA256 = (
    "f78cd6cc94e3b46a87782d7486a08c530afc0e9bfe29d63e502ce269bdddd35a"
)
