...
RECON = REPO / "docs/evidence/security/CDB_SECURITY_BACKLOG_RECONCILIATION_2026-08-05.json"
MD = REPO / "docs/evidence/security/CDB_SECURITY_BACKLOG_RECONCILIATION_2026-08-05.md"
ALLOWED = frozenset({
    "FIX_READY","FIXED_SCAN_VERIFIED","UPSTREAM_BLOCKED","DUPLICATE_CANONICAL_TRACKER",
    "FALSE_POSITIVE_WITH_PROOF","SECRET_OWNER_ACTION_REQUIRED","NEEDS_EVIDENCE",
