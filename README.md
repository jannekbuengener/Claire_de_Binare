# Claire de Binaire – Cleanroom Repository

Dieses Repository enthält die Cleanroom-Grundstruktur, Planungsartefakte und Runbooks für die spätere Bereinigung und Härtung der ursprünglichen Codebasis.

## Strukturüberblick
- `docs/` – Strategiedokumente, Migrationskarten, Sicherheitspläne und ergänzende Laufwerke.
