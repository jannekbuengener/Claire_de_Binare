...
Siehe `scripts/migrate-labels.py` (falls benötigt).

**Achtung:** Milestone-Labels (`milestone:m1-m9`) und Epic-Labels (`epic:*`) wurden entfernt.  
→ Verwende stattdessen **GitHub Milestones** und **GitHub Projects** für Epics.
...
- **Auto-Label PRs:** `.github/workflows/labeler.yml` (falls vorhanden)
