...
| P1 | Negative Payload | PARTIAL | NO | `#781` closed; execution-path tests + invalid-payload metric exist via PR #1107, but no dedicated `LR-012` evidence artifact / full-scope proof | jannekbuengener |
