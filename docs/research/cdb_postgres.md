...
docker exec -i cdb_postgres psql -U claire -d claire_de_binare < \
    backoffice/docs/DATABASE_SCHEMA_V1.1_IMPROVED.sql

## 4. Load Test Data (optional)
docker exec -i cdb_postgres psql -U claire -d claire_de_binare < \
    backoffice/docs/TEST_DATA_REALISTIC.sql
```
...
docker cp backoffice/docs/DATABASE_SCHEMA_V1.1_MIGRATION.sql cdb_postgres:/tmp/
