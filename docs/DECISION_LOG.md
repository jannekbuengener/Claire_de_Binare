...
- Dokumentation: `backoffice/docs/MCP_SETUP_GUIDE.md` (420+ Zeilen)
...
- C) Eigenen MCP-Server für Claire de Binaire entwickeln und im Docker Catalog veröffentlichen
...
- Custom MCP-Server für Claire de Binaire entwickeln (`claire-de-binare-mcp`)
...
- Dokumentation: `backoffice/docs/DOCKER_MCP_TOOLKIT_SETUP.md` (500+ Zeilen)
- Bereiche: Toolkit-Aktivierung, Gordon-Setup, Security (OAuth, Secrets), Custom Server Template
- Gordon Test-Prompts für Claire de Binaire erstellt (Container-Status, Health-Checks, Log-Analyse)
...
**Gordon Use Cases für Claire de Binaire**:
...
**Entscheidung**: Option B – Zentrale Tool Registry in `backoffice/docs/TOOL_LAYER.md` mit klarer Kategorisierung und Statusverfolgung.
...
- Docker-Runbooks im `ops/RUNBOOK_DOCKER_OPERATIONS.md` und in der `EXECUTION_DEBUG_CHECKLIST.md` verweisen auf verpflichtende Gordon-Freigabe
...
- `backoffice/docs/smarter_assistant/Knowledge_Map.md` erstellt (Navigation, 1/2-Hop-Ketten)
- `backoffice/docs/smarter_assistant/semantic_index.json` erzeugt (Knoten, Kanten, Cluster)
...
- `backoffice/docs/smarter_assistant/Normalization_Report.md` erstellt (Port-, Secret-, Event-/Alert-Deltas dokumentiert)
...
- ➕ Einheitlicher Blick auf alle Kandidaten über `backoffice/docs/smarter_assistant/migration_plan.md`
...
- `backoffice/docs/PR_REVIEW_BATCH_2025_11_09.md` (Detailanalyse)
...
Referenzen:
- backoffice/docs/KANBAN_SETUP.md
