...
cp artifacts/soak_test_20260325_121250/lr040_soak_gate_eval.json \
   docs/evidence/reports/p5_canary/2026-03-28/lr040/lr040_soak_gate_eval.json
```
...
```bash
mkdir -p docs/evidence/reports/p5_canary/2026-03-28/endpoints

curl -s http://127.0.0.1:8002/kill-switch > docs/evidence/reports/p5_canary/2026-03-28/endpoints/kill_switch_status.json
curl -s http://127.0.0.1:8003/status      > docs/evidence/reports/p5_canary/2026-03-28/endpoints/execution_status.json
curl -s http://127.0.0.1:8002/status      > docs/evidence/reports/p5_canary/2026-03-28/endpoints/risk_status.json
```
...
for f in prestart_evidence_lock.yaml decision_record.yaml \
  ...
  echo "$f: $(sha256sum docs/evidence/reports/p5_canary/2026-03-28/$f | awk '{print $1}')"
done
```
...
```bash
git add docs/evidence/reports/p5_canary/2026-03-28/
