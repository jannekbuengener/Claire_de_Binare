...
- `backoffice/docs/DECISION_LOG.md` - ADR-007 hinzugefügt (MCP Stack)
...
**Status:** ✅ Dokumentiert in `backoffice/docs/DECISION_LOG.md`
...
- `docker/mcp/QUICK_START.md` - 5-Minuten-Installation (300+ Zeilen)
- `backoffice/docs/DECISION_LOG.md` - ADR-007 (MCP Stack)
