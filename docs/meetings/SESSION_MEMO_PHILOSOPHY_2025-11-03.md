...
**Datei**: `backoffice/docs/DECISION_LOG.md`
...
**Datei**: `backoffice/docs/DEVELOPMENT.md`
...
**Datei**: `backoffice/docs/ARCHITEKTUR_REGELN.md`
...
## - backoffice/docs/DEVELOPMENT.md
## - backoffice/docs/ARCHITEKTUR_REGELN.md
...
- `backoffice/docs/DECISION_LOG.md` (ADR-031 neu)
- `backoffice/docs/DEVELOPMENT.md` (Abschnitt 0️⃣ neu)
- `backoffice/docs/ARCHITEKTUR_REGELN.md` (Abschnitt 6 neu)
