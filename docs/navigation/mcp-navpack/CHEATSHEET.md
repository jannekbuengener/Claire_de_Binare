...
- **New developer visual start:** [`docs/onboarding/DEVELOPER_VISUAL_START_HERE.md`](../../onboarding/DEVELOPER_VISUAL_START_HERE.md) — Mermaid flow, examples, templates.
- **CDB terminology:** [`docs/onboarding/cdb_glossary.md`](../../onboarding/cdb_glossary.md) — LR, SSOT, eventflow and agent terms.
...
- **Navpack:** `docs/navigation/mcp-navpack/ENTRYPOINTS.yaml` (machine-readable read order) and this CHEATSHEET.
...
- Root is allowlisted by `config/repository/root_layout.json`; reports, manifests,
  navigation packs, and governance documentation belong in their domain folders.
