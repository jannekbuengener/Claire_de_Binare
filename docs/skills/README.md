...
## Kanonische Skill-Dateien (30 aktive CDB-Repo-Skills)
...
| `cdb-debug-handoff` | [`cdb-debug-handoff/SKILL.md`](cdb-debug-handoff/SKILL.md) | opencode, cursor, codex, claude |
