...
> Archived 2026-07-15. Historical process evidence for the closed governance
> audit #328; not an active operating instruction. Current automation and
> runbooks are indexed in `docs/runbooks/` and `.github/CONTROL_PLANE.md`.
